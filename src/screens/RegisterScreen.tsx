...
export default function RegisterScreen({ onNavigateToLogin }: Props) {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      const errMsg = e.response?.data?.message || e.response?.data || 'Пользователь уже существует или данные некорректны';
      setError(typeof errMsg === 'string' ? errMsg : 'Ошибка регистрации');
    } finally {
      setLoading(false);
    }
  };
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer} keyboardShouldPersistTaps="handled">
        <View style={styles.header}>
          ...
          <Text style={[styles.subtitle, { color: themeColors.textMuted }]}>
            Создайте аккаунт, чтобы начать цифровой детокс
          </Text>
        </View>

        <View style={[styles.card, { backgroundColor: themeColors.glass, borderColor: themeColors.border }]}>
          <Text style={[styles.cardTitle, { color: themeColors.text }]}>Регистрация</Text>
          ...
          {/* Email Input */}
          <Text style={[styles.inputLabel, { color: themeColors.textMuted }]}>Электронная почта</Text>
          <View style={[styles.inputContainer, { borderColor: themeColors.border }]}>
        ...
        <View style={styles.footer}>
          <Text style={{ color: themeColors.textMuted }}>Уже есть аккаунт? </Text>
